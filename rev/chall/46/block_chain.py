...
def encrypt(plaintext, inner_txt, key):
    ...
    block_size = 16
    plaintext = pad(modified_plaintext, block_size)  # That line is adding PKCS#7 padding
...
def main(token):
    ...
    genesis_block = Block(0, "0", int(time.time()), "EncodedGenesisBlock", 0)   # genesis block.
